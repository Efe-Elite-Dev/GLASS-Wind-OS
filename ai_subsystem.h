 ...
 * alarak çekirdeğin ana zamanlayıcısına (Scheduler) dinamik kuantum sürelerini enjekte eder.
 * * @param predicted_load Tahmin edilen % CPU yükü
 * @param anomaly_flag Donanımsal sapma/hata alarmı (0 veya 1)
 * @param policy Sistem güç/performans politikası (0: Standart, 1: Performans, 2: Güç Koruma)
 */
